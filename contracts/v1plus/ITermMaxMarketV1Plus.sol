...
/**
 * @title TermMax Market V1Plus interface
 * @author Term Structure Labs
 * @notice Interface for TermMax V1Plus markets with enhanced functionality over V1
 * @dev Extends the base market functionality with additional features for better user experience
 */
interface ITermMaxMarketV1Plus {
    /**
     * @notice Returns the human-readable name of the market
     * @dev Used for identification and display purposes in V1Plus markets
     ...
     * @dev V1Plus enhancement allowing third-party burning with proper authorization
     ...
     * @dev V1Plus enhancement allowing leverage creation on behalf of another address
     ...
     * @dev V1Plus enhancement allowing third-party redemption with proper authorization
