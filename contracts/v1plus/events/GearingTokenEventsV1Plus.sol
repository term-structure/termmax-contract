...
/**
 * @title Gearing Token Events V1Plus
 * @author Term Structure Labs
 * @notice Interface defining events for Gearing Token operations in TermMax V1Plus protocol
 */
interface GearingTokenEventsV1Plus {
    /**
