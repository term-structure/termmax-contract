...
/**
 * @title Router Events V1Plus
 * @author Term Structure Labs
 * @notice Interface defining events for the TermMax V1Plus protocol's router operations
 */
interface RouterEventsV1Plus {
    /**
     * @notice Emitted when a new order is placed in the TermMax V1Plus protocol
