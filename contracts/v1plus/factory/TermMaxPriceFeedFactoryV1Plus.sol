...
/**
 * @title TermMax Price Feed Factory V1Plus
 * @author Term Structure Labs
 * @notice Factory contract for creating various types of price feeds in the TermMax V1Plus protocol
 ...
 */
contract TermMaxPriceFeedFactoryV1Plus {
    /**
    ...
    function createPriceFeedWithERC4626(address _assetPriceFeed, address _vault) external returns (address) {
        ...
        emit FactoryEventsV1Plus.PriceFeedCreated(priceFeed);
        return priceFeed;
    }
