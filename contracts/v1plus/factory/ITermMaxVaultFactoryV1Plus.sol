...
/**
 * @title TermMax Vault Factory Interface V1Plus
 * @author Term Structure Labs
 * @notice Interface for creating new TermMax vaults
 */
interface ITermMaxVaultFactoryV1Plus {
    /**
     ...
     */
    function createVault(VaultInitialParamsV1Plus memory initialParams, uint256 salt) external returns (address);
}
