...
import {GearingTokenWithERC20V1Plus} from "../tokens/GearingTokenWithERC20V1Plus.sol";
...
/**
 * @title TermMax Factory V1Plus
 * @author Term Structure Labs
 * @notice Factory contract for creating TermMax V1Plus markets with enhanced functionality
 * @dev Manages market deployment, gearing token implementations, and market configuration validation
 * Inherits from V1 factory interface while adding V1Plus-specific features for improved market creation
 */
contract TermMaxFactoryV1Plus is Ownable2Step, ITermMaxFactory, FactoryEventsV1Plus {
    ...
    /**
     * @notice Constructs the TermMax Factory V1Plus with initial configurations
    ...
    constructor(address admin, address TERMMAX_MARKET_IMPLEMENTATION_) Ownable(admin) {
        ...
        gtImplements[GT_ERC20] = address(new GearingTokenWithERC20V1Plus());
    }
        ...
        returns (address market)
    {
        ...
        emit FactoryEventsV1Plus.MarketCreated(market, params.collateral, params.debtToken, params);
    }
}
