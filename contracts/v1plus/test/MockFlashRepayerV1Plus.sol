...
import {IGearingToken, IGearingTokenV1Plus, IERC20, IFlashRepayer} from "../tokens/AbstractGearingTokenV1Plus.sol";
import {IERC721Receiver} from "@openzeppelin/contracts/interfaces/IERC721Receiver.sol";

contract MockFlashRepayerV1Plus is IFlashRepayer, IERC721Receiver {
    IGearingToken gt;
    ...
    function flashRepay(uint256 id, uint128 repayAmt, bool byUnderlying, bytes calldata removedCollateral) external {
        ...
        bool repayAll = IGearingTokenV1Plus(address(gt)).flashRepay(id, repayAmt, byUnderlying, removedCollateral, "");
        if (!repayAll) {
