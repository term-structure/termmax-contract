    ...
    OrderEvents
{
    ...
    function swapExactTokenToToken(
        ...
        if (tokenOut == debtToken) {
            ITermMaxMarketV1Plus(address(market)).burn(address(this), recipient, minTokenOut);
        } else {
    ...
    function swapTokenToExactToken(
        ...
        if (tokenOut == debtToken) {
            ITermMaxMarketV1Plus(address(market)).burn(address(this), recipient, tokenAmtOut);
        } else {
