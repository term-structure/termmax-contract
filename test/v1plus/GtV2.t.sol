...
import {MockFlashRepayerV1Plus} from "contracts/v1plus/test/MockFlashRepayerV1Plus.sol";
import {ISwapCallback} from "contracts/v1/ISwapCallback.sol";

contract GtTestV1Plus is Test {
    ...
    MockFlashRepayerV1Plus flashRepayer;
    ...
    function setUp() public {
        ...
        flashRepayer = new MockFlashRepayerV1Plus(res.gt);
    ...
    function testMintGtWhenOracleOutdated() public {
        ...
        res.oracle.submitPendingOracle(
            address(res.collateral), IOracleV1Plus.Oracle(res.collateralOracle, res.collateralOracle, 0, 0, 3600, 3600)
        );
        ...
        vm.expectRevert(abi.encodeWithSelector(IOracleV1Plus.OracleIsNotWorking.selector, address(res.collateral)));
    ...
    function testReapyByDebtToken() public {
        ...
        vm.expectEmit();
        emit GearingTokenEventsV1Plus.Repay(gtId, debtAmt, byDebtToken, true);
    ...
    function testPatriallyReapy() public {
        ...
        bool byDebtToken = true;
        vm.expectEmit();
        emit GearingTokenEventsV1Plus.Repay(gtId, repayAmt, byDebtToken, false);
        ...
        vm.expectEmit();
        emit GearingTokenEventsV1Plus.Repay(gtId, debtAmt - repayAmt, byDebtToken, true);
    ...
    function testFlashRepay() public {
        ...
        bool byDebtToken = true;
        vm.expectEmit();
        emit GearingTokenEventsV1Plus.FlashRepay(
    ...
    function testRevertByGtIsExpiredWhenRepay() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(GearingTokenErrorsV1Plus.GtIsExpired.selector));
    ...
    function testMergeEmptyArray() public {
        ...
        vm.startPrank(sender);
        vm.expectRevert(abi.encodeWithSelector(GearingTokenErrorsV1Plus.GtIdArrayIsEmpty.selector));
        res.gt.merge(ids);
        vm.stopPrank();
    }
    ...
    function testRemoveCollateralWhenOracleOutdated() public {
        ...
        vm.prank(deployer);
        res.oracle.submitPendingOracle(
            address(res.collateral), IOracleV1Plus.Oracle(res.collateralOracle, res.collateralOracle, 0, 0, 3500, 3500)
        );
        vm.prank(deployer);
        res.oracle.acceptPendingOracle(address(res.collateral));
        vm.warp(block.timestamp + 3600);
        ...
        vm.prank(deployer);
        res.oracle.submitPendingOracle(
            address(res.collateral), IOracleV1Plus.Oracle(res.collateralOracle, res.collateralOracle, 0, 0, 0, 0)
        );
        vm.prank(deployer);
        res.oracle.acceptPendingOracle(address(res.collateral));
