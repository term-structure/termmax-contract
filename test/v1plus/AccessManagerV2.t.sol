...
import {
    IOwnable, IPausable, AccessManagerV1Plus, AccessManager
} from "contracts/v1plus/access/AccessManagerV1Plus.sol";
...
import {ITermMaxVault, TermMaxVaultV1Plus} from "contracts/v1plus/vault/TermMaxVaultV1Plus.sol";
import {Constants} from "contracts/v1/lib/Constants.sol";
import "contracts/v1/storage/TermMaxStorage.sol";
import {IOracleV1Plus} from "contracts/v1plus/oracle/IOracleV1Plus.sol";
import {VaultInitialParamsV1Plus} from "contracts/v1plus/storage/TermMaxStorageV1Plus.sol";

contract AccessManagerTestV1Plus is Test {
    ...
    function setUp() public {
        ...
        AccessManagerV1Plus implementation = new AccessManagerV1Plus();
        ...
        manager = AccessManagerV1Plus(proxy);
    ...
    function testBatchSetSwitch() public {
        ...
        VaultInitialParamsV1Plus memory params = VaultInitialParamsV1Plus({
    ...
    function testUpgradeSubContract() public {
        ...
        TermMaxRouterV1Plus routerV1Plus = new TermMaxRouterV1Plus();

        // Test upgrade with DEFAULT_ADMIN_ROLE
        manager.upgradeSubContract(UUPSUpgradeable(address(res.router)), address(routerV1Plus), "");
    ...
    function testSubmitAndAcceptPendingOracle() public {
        ...
        manager.submitPendingOracle(IOracleV1Plus(address(res.oracle)), asset, oracle);
        vm.stopPrank();
    ...
    function testRevokePendingOracle() public {
        ...
        manager.revokePendingOracle(IOracleV1Plus(address(res.oracle)), asset);
        vm.stopPrank();
