...
import {
    ...
    OrderEvents,
    OrderErrors
} from "contracts/v1plus/TermMaxOrderV1Plus.sol";
...
contract OrderTestV1Plus is Test {
    ...
    function testPauseAndUnpause() public {
        ...
        // Test pause
        res.order.pause();
        assertTrue(TermMaxOrderV1Plus(address(res.order)).paused());
        ...
        // Test unpause
        res.order.unpause();
        assertFalse(TermMaxOrderV1Plus(address(res.order)).paused());
