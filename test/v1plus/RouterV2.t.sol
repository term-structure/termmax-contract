...
import {
    ...
    RouterErrors,
    RouterEvents
} from "contracts/v1plus/router/TermMaxRouterV1Plus.sol";
import {ITermMaxRouter} from "contracts/v1/router/ITermMaxRouter.sol";
import {MockSwapAdapterV1Plus} from "contracts/v1plus/test/MockSwapAdapterV1Plus.sol";
import {ITermMaxOrder} from "contracts/v1/ITermMaxOrder.sol";

contract RouterTestV1Plus is Test {
    ...
    function setUp() public {
        ...
        adapter = new MockSwapAdapterV1Plus(pool);
    ...
    function testPlaceOrderForV1Plus() public {
        vm.startPrank(sender);
        ...
        (ITermMaxOrder order, uint256 gtId) = res.router.placeOrderForV1Plus(
            res.market, sender, collateralToMintGt, debtTokenToDeposit, ftToDeposit, xtToDeposit, orderConfig
        );
