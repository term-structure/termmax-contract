...
import {OrderEventsV1Plus} from "contracts/v1plus/events/OrderEventsV1Plus.sol";

contract MarketV1PlusTest is Test {
    ...
    function testBurn() public {
        ...
        ITermMaxMarketV1Plus(address(res.market)).burn(sender, sender, amount);
    ...
    function testCreateOrder() public {
        ...
        vm.expectEmit();
        emit OrderEventsV1Plus.OrderInitialized(sender, address(res.market), orderConfig);
        ITermMaxOrder order =
    ...
    function testRedeem() public {
        ...
        ITermMaxMarketV1Plus(address(res.market)).redeem(bob, bob, depositAmt);
    ...
    function testRedeemBeforeDeadline() public {
        ...
        ITermMaxMarketV1Plus(address(res.market)).redeem(sender, sender, depositAmt);
